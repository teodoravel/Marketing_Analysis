...
histogram <- ggplot(data.frame(x = hist_data$mids, y = hist_data$counts), aes(x = x, y = y)) +
  ...
  labs(title = "Хистограм: Маркетинг Буџети", x = "Маркетинг Буџети (илјадници)", y = "Честоти")
...
histogram2 <- ggplot(data.frame(x = hist_data2$mids, y = hist_data2$counts), aes(x = x, y = y)) +
  ...
  labs(title = "Хистограм: Продажби (милиони)", x = "Продажби (милиони)", y = "Честоти")
...
polygon_plot2 <- ggplot(polygon_data2, aes(x = x, y = y)) +
  ...
  labs(title = "Полигон на честоти: Продажби",
       x = "Продажби (милиони)", y = "Честоти")
